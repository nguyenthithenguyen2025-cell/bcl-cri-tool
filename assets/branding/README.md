# Thư mục logo nhận diện

Đặt các logo chính thức vào thư mục này để app tự hiển thị ở sidebar.
...
## Lưu ý triển khai Streamlit Cloud

Các logo cần được commit vào GitHub thì Streamlit Cloud mới hiển thị được. Sau khi thêm logo, cần commit và push lại repository.
